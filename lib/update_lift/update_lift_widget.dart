...
import 'update_lift_model.dart';
export 'update_lift_model.dart';

class UpdateLiftWidget extends StatefulWidget {
...
class _UpdateLiftWidgetState extends State<UpdateLiftWidget> {
  late UpdateLiftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateLiftModel());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color(0xFF42103E),
                    ...
                    return Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: TextFormField(
                            controller: _model.textController1 ??=
                              ...
                              text: columnLiftsRecord.liftname,
                            ),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            controller: _model.textController2 ??=
                                TextEditingController(
                              text: columnLiftsRecord.departureAddress,
                            ),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            controller: _model.textController3 ??=
                                TextEditingController(
                              text: columnLiftsRecord.destinationAddress,
                            ),
                        ...
                        FlutterFlowCalendar(
                          ...
                          initialDate: columnLiftsRecord.day,
                          rowHeight: 30.0,
                            ...
                            onPressed: () async {
                              await widget.liftDocRef!.update({
                                ...createLiftsRecordData(
                                  ...
                                  createdBy: columnLiftsRecord.createdBy,
                                  cost:
                                      int.tryParse(_model.textController4.text),
                                ),
                                ...mapToFirestore(
                                  {
                                    'rideshare_members': FieldValue.arrayUnion(
                                        [currentUserReference]),
                                  },
                                ),
                              });

                              context.pushNamed('lifts');
                            },
                            text: 'Update Lift',
                            options: FFButtonOptions(
                              height: 40.0,
