...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'lifts',
          path: '/lifts',
          builder: (context, params) => const LiftsWidget(),
        ),
        FFRoute(
          name: 'create_lift',
          path: '/createLift',
          builder: (context, params) => const CreateLiftWidget(),
        ),
        FFRoute(
          name: 'Lift_Details',
          path: '/liftDetails',
          builder: (context, params) => LiftDetailsWidget(
        ...
        FFRoute(
          name: 'update_lift',
          path: '/updateLift',
          builder: (context, params) => UpdateLiftWidget(
            liftDocRef: params.getParam(
              'liftDocRef',
              ParamType.DocumentReference,
              isList: false,
